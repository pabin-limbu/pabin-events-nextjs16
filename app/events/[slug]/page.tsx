...
const EventDetailItem = ({icon, alt, label}: { icon: string, alt: string, label: string }) => (
    <div className="flex-row-gap-2 items-center">
        <Image src={icon} alt={alt} height={17} width={17} className={""}/>
        <p>{label}</p>
    </div>
)
...
const EventDetailsPage = async ({params}: {
    ...
    try {
        ...
        const similarEvents: EventType[] = await getSimilarEventsBySlug(slug);
            ...
            <section id={"event"}>
                ...
                <div className="details">
                    ...
                    <div className="content">
                        <Image src={image} alt={"banner Image"} height={800} width={800} className={"banner"}/>
